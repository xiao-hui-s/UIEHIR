...
class MF(BaseEstimator, TransformerMixin):
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():  # , tf.device('/cpu:0'):
            ...
            # self.item_latent_p = tf.multiply(self.item_latent_p, self.beta)
            # self.user_latent_p = tf.multiply(self.user_latent_p, self.other_beta)
    ...
    def get_random_block_from_data(self, train_data, batch_size):  # generate a random block of training data
        ...
        lenu2_n = max(cu2_n)
        lenu3_n = max(cu3_n)
        # maxlenu_n = max(lenu1_n, lenu2_n, lenu3_n)
